 ...
 * DESCRIPCIÓN: Esta es la clase modelo que encapsula toda la información de un
 * proyecto:
 ...
 * IMPLEMENTS: Serializable - Permite serializar objetos para almacenamiento o
 * transmisión
 */
public class Proyecto implements Serializable {
    ...
    private int anio;
    // Categoría del proyecto (Proyecto, Trabajo Especial de Grado, Investigación,
    // etc.)
    ...
    // URLs de recursos relacionados (campo opcional, debe ser único si no está
    // vacío)
     ...
     * UTILIDAD: Usado por frameworks como Hibernate, JSP, y conversión de JSON a
     * objeto
     */
    public Proyecto() {
    }
     ...
     * PARÁMETROS: Todos los campos principales (excepto id y fecha que se asignan
     * en BD)
     * ASIGNACIÓN AUTOMÁTICA: fechaRegistro se asigna con la hora actual
     * (LocalDateTime.now())
     */
    ...
    // Nota: Getters y setters permiten acceso controlado a los campos del modelo
    ...
    // FUNCIÓN: Asignar la categoría (Proyecto, Trabajo Especial de Grado,
    // Investigación, etc.)
    ...
    // FUNCIÓN: Asignar la fecha de registro (normalmente asignada automáticamente
    // por la BD)
