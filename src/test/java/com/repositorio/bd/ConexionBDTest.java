...
public class ConexionBDTest {
    ...
    public void testPermitirMismoAnioDistintoNombreYEnlace() {
        Proyecto p1 = new Proyecto("Proyecto A", "Autor A", 2024, "Proyecto", "Resumen A", "claveA", "http://recursoA",
                "a@a.com");
        Proyecto p2 = new Proyecto("Proyecto B", "Autor B", 2024, "Proyecto", "Resumen B", "claveB", "http://recursoB",
                "b@b.com");
        ...
        assertTrue(ConexionBD.insertarProyecto(p2),
                "Inserción de p2 (mismo año, distinto nombre/enlace) debería ser exitosa");
    }

    @Test
    public void testRechazarDuplicadoExacto() {
        Proyecto p1 = new Proyecto("Proyecto X", "Autor X", 2023, "Investigación", "Resumen X", "claveX",
                "http://linkX", "x@x.com");
        Proyecto pDup = new Proyecto("Proyecto X", "Autor X", 2023, "Investigación", "Resumen X", "claveX",
                "http://linkX", "x@x.com");
